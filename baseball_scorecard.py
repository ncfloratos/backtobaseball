...
def parse_play_description(description):
    ...
    if 'line drive' in description:
        if 'left field' in description or 'lf' in description:
            ...
            return 'L9'
        elif 'shortstop' in description or 'ss' in description:
            return 'L6'
        elif 'second base' in description or '2b' in description:
            return 'L4'
        elif 'third base' in description or '3b' in description:
            return 'L5'
        elif 'first base' in description or '1b' in description:
            return 'L3'
        elif 'pitcher' in description or 'p' in description:
            return 'L1'
        elif 'catcher' in description or 'c' in description:
            return 'L2'
   ...
   # **Flyouts & Groundouts**
    ...
    # **Groundouts**
    if 'groundout' in description or 'force out' in description:
        if 'shortstop' in description or 'ss' in description:
            return 'GO6'
        elif 'second base' in description or '2b' in description:
            return 'GO4'
        elif 'third base' in description or '3b' in description:
